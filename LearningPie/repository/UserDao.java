...
public interface UserDao extends JpaRepository<User, Integer>  {
	...
	@Query(value= "select * from user where user_name:un and email:e", nativeQuery=true)
	public User checkUserNameAndEmail(@Param("un") String userName, @Param("e") String email);
...
//	for Password Update
	@Modifying
	@Transactional
	@Query(value="update user set password=:p where user_name=:un", nativeQuery = true)
	public int updatePassword(@Param("p") String password, @Param("un") String userName);
}
